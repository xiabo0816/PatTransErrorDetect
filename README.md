...
英文参考文献识别
([A-Z][a-z]{0,}, )
((([A-Za-z]{1}(-[A-Z]){0,}\.((-[A-Z]{1}),){0,})+ ?){0,},?( et[ ]{1,2}al\.){0,}, )
(([A-Z][a-z]{0,}\.?) ?)+
([\d\(\)]+:)([\d -]+) ?(\( ?[\d]{4}\))\.
```
...
Sambrook  et  al.,1989,Molecular  Cloning,A  Laboratory  Manual,second  edition,Cold  Spring  Harbor  Press,Plainview;NYのセクション9.37~9.52参照。
